#############################################################################
# Makefile for building: BookInventory
# Generated by qmake (3.0) (Qt 5.6.1)
# Project:  ../BookInventory/BookInventory.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../BookInventory/BookInventory.pro
#############################################################################
...
INCPATH       = -I../BookInventory -I. -isystem /usr/include/qt5 -isystem /usr/include/qt5/QtWidgets -isystem /usr/include/qt5/QtGui -isystem /usr/include/qt5/QtCore -I. -I. -I/usr/lib64/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = BookInventory1.0.0
DISTDIR = /home/tennantc/Documents/build-BookInventory-Desktop-Debug/.tmp/BookInventory1.0.0
LINK          = g++
LFLAGS        = 
...
SOURCES       = ../BookInventory/main.cpp \
		../BookInventory/book_inventory.cpp moc_book_inventory.cpp
OBJECTS       = main.o \
		book_inventory.o \
		moc_book_inventory.o
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		../BookInventory/BookInventory.pro ../BookInventory/book_inventory.h ../BookInventory/main.cpp \
		../BookInventory/book_inventory.cpp
QMAKE_TARGET  = BookInventory
DESTDIR       = 
TARGET        = BookInventory


first: all
####### Build rules

$(TARGET): ui_book_inventory.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: ../BookInventory/BookInventory.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib64/qt5/mkspecs/features/yacc.prf \
		/usr/lib64/qt5/mkspecs/features/lex.prf \
		../BookInventory/BookInventory.pro \
		/usr/lib64/libQt5Widgets.prl \
		/usr/lib64/libQt5Gui.prl \
		/usr/lib64/libQt5Core.prl
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../BookInventory/BookInventory.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ../BookInventory/book_inventory.h $(DISTDIR)/
	$(COPY_FILE) --parents ../BookInventory/main.cpp ../BookInventory/book_inventory.cpp $(DISTDIR)/
	$(COPY_FILE) --parents ../BookInventory/book_inventory.ui $(DISTDIR)/
...
compiler_moc_header_make_all: moc_book_inventory.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_book_inventory.cpp
moc_book_inventory.cpp: ../BookInventory/book_inventory.h \
		moc_predefs.h
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/home/tennantc/Documents/BookInventory -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I/usr/include/c++/4.8.5 -I/usr/include/c++/4.8.5/x86_64-redhat-linux -I/usr/include/c++/4.8.5/backward -I/usr/lib/gcc/x86_64-redhat-linux/4.8.5/include -I/usr/local/include -I/usr/include ../BookInventory/book_inventory.h -o moc_book_inventory.cpp

compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_book_inventory.h
compiler_uic_clean:
	-$(DEL_FILE) ui_book_inventory.h
ui_book_inventory.h: ../BookInventory/book_inventory.ui
	/usr/lib64/qt5/bin/uic ../BookInventory/book_inventory.ui -o ui_book_inventory.h
...
main.o: ../BookInventory/main.cpp ../BookInventory/book_inventory.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../BookInventory/main.cpp

book_inventory.o: ../BookInventory/book_inventory.cpp ../BookInventory/book_inventory.h \
		ui_book_inventory.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o book_inventory.o ../BookInventory/book_inventory.cpp

moc_book_inventory.o: moc_book_inventory.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_book_inventory.o moc_book_inventory.cpp
